        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="dropdown-item" target="_blank" href="{{ url('/') }}">Profile</a></li>
                                <li><a class="dropdown-item" target="_blank" href="{{ url('/') }}">Contacts</a></li>
                                <li><a class="dropdown-item" target="_blank" href="{{ url('/') }}">Mailbox</a></li>
                                <li class="dropdown-divider"></li>
                                <li><a class="dropdown-item" target="_blank" href="{{ url('login') }}">Logout</a></li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <a href="{{ url('azizulhasan') }}"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="{{ url('allcreate.portfolioisotopes') }}">portfolioisotopes add</a></li>
                            <li><a href="{{ url('allcreate.socialicons') }}">socialicons add</a></li>
                            <li><a href="{{ url('allcreate.rightnames') }}">rightnames add</a></li>
                        </ul>
                    </li>
                    <li>
