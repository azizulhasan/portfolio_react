        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a class="nav-link active" data-toggle="tab" href="#tab-2">all users contacts View</a></li>
                        {{-- @isset($edit)
                    ...
                    {{-- <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                ...
                                <form action="{{ route('store.usercontacts') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                <fieldset>
                ...
                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                  ...
                  {{-- {{ $user->address }} --}}
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                               <a href="{{ URL::to('view/usercontacts/'.$user->id) }}"><button class="btn-white btn btn-xs">View</button></a>
                               <a href="{{ URL::to('edit/usercontacts/'.$user->id) }}"><button class="btn-white btn btn-xs">Edit</button></a>
                               <a href="{{ URL::to('delete/usercontacts/'.$user->id) }}"><button class="btn-white btn btn-xs">Delete</button></a>
