                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                ...
                                <form action="{{ route('store.portfolioisotopes') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                <fieldset>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">title:</label>
                                        <div class="col-sm-10"><input type="text" name="title" class="form-control" placeholder="title"></div>
                                    </div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">filter name:</label>
                                        <div class="col-sm-10"><input type="text" name="filtername" class="form-control" placeholder="filter name"></div>
                                    </div>
        ...
        <div class="ibox">
            <div class="ibox-content">
                ...
                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                    ...
                    <tbody>
                  {{-- {{ $user->address }} --}}
                     @foreach($portfolioisotopes as $data);
                    <tr>
                        <td>
                          {{ $data->id }}
                        </td>
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                               <a href="{{ URL::to('view/portfolioisotopes/'.$data->id) }}"><button class="btn-white btn btn-xs">View</button></a>
                               <a href="{{ URL::to('edit/portfolioisotopes/'.$data->id) }}"><button class="btn-white btn btn-xs">Edit</button></a>
                               <a href="{{ URL::to('delete/portfolioisotopes/'.$data->id) }}"><button class="btn-white btn btn-xs">Delete</button></a>
                    ...
                    <div id="tab-3" class="tab-pane">
                        <div class="panel-body">
                            @isset($edit)
                            <form action="{{URL::to('update/portfolioisotopes/'.$edit->id)  }}" method="post" enctype="multipart/form-data">
                                @csrf
                            <fieldset>
                                <div class="form-group row"><label class="col-sm-2 col-form-label">title:</label>
